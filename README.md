...
Docker images are built in layers, a core compoment of images is known as the 'base layer'. This is the foundation upon which all other components/layers are added. Commonly, base layers are minimal, and typically respresentative of common OSs.
